package Graphics::Gnuplot::Palettes::Brewer::Reds;
...
our @EXPORT_OK = qw($Reds);
our $Reds = 'set palette defined ( 0 "#FFF5F0", 1 "#FEE0D2", 2 "#FCBBA1", 3 "#FC9272", 4 "#FB6A4A", 5 "#EF3B2C", 6 "#CB181D", 7 "#99000D" )';
