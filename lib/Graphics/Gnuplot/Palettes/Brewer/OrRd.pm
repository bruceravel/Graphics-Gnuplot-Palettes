package Graphics::Gnuplot::Palettes::Brewer::OrRd;
...
our @EXPORT_OK = qw($OrRd);
our $OrRd = 'set palette defined ( 0 "#FFF7EC", 1 "#FEE8C8", 2 "#FDD49E", 3 "#FDBB84", 4 "#FC8D59", 5 "#EF6548", 6 "#D7301F", 7 "#990000" )';
