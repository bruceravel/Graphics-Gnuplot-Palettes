package Graphics::Gnuplot::Palettes::Brewer::Diverging_RdBu;
...
our @EXPORT_OK = qw($Diverging_RdBu);
our $Diverging_RdBu = 'defined ( 0 "#B2182B", 1 "#D6604D", 2 "#F4A582", 3 "#FDDBC7", 4 "#D1E5F0", 5 "#92C5DE", 6 "#4393C3", 7 "#2166AC" )';
