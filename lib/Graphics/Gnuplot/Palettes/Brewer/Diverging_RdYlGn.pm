package Graphics::Gnuplot::Palettes::Brewer::Diverging_RdYlGn;
...
our @EXPORT_OK = qw($Diverging_RdYlGn);
our $Diverging_RdYlGn = 'defined ( 0 "#D73027", 1 "#F46D43", 2 "#FDAE61", 3 "#FEE08B", 4 "#D9EF8B", 5 "#A6D96A", 6 "#66BD63", 7 "#1A9850" )';
