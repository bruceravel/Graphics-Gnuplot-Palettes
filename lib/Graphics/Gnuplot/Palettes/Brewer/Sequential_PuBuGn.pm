package Graphics::Gnuplot::Palettes::Brewer::Sequential_PuBuGn;
...
our @EXPORT_OK = qw($Sequential_PuBuGn);
our $Sequential_PuBuGn = 'defined ( 0 "#FFF7FB", 1 "#ECE7F0", 2 "#D0D1E6", 3 "#A6BDDB", 4 "#67A9CF", 5 "#3690C0", 6 "#02818A", 7 "#016540" )';
