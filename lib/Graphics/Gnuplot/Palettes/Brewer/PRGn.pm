package Graphics::Gnuplot::Palettes::Brewer::PRGn;
...
our @EXPORT_OK = qw($PRGn);
our $PRGn = 'set palette defined ( 0 "#762A83", 1 "#9970AB", 2 "#C2A5CF", 3 "#E7D4E8", 4 "#D9F0D3", 5 "#A6DBA0", 6 "#5AAE61", 7 "#1B7837" )';
