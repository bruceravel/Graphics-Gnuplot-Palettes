package Graphics::Gnuplot::Palettes::Brewer::Qualitative_Pastel1;
...
our @EXPORT_OK = qw($Qualitative_Pastel1);
our $Qualitative_Pastel1 = 'defined ( 0 "#FBB4AE", 1 "#B3CDE3", 2 "#CCEBC5", 3 "#DECBE4", 4 "#FED9A6", 5 "#FFFFCC", 6 "#E5D8BD", 7 "#FDDAEC" )';
