package Graphics::Gnuplot::Palettes::Brewer::Greens;
...
our @EXPORT_OK = qw($Greens);
our $Greens = 'set palette defined ( 0 "#F7FCF5", 1 "#E5F5E0", 2 "#C7E9C0", 3 "#A1D99B", 4 "#74C476", 5 "#41AB5D", 6 "#238B45", 7 "#005A32" )';
