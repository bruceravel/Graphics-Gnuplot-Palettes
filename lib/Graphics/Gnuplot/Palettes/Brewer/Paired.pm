package Graphics::Gnuplot::Palettes::Brewer::Paired;
...
our @EXPORT_OK = qw($Paired);
our $Paired = 'set palette defined ( 0 "#A6CEE3", 1 "#1F78B4", 2 "#B2DF8A", 3 "#33A02C", 4 "#FB9A99", 5 "#E31A1C", 6 "#FDBF6F", 7 "#FF7F00" )';
