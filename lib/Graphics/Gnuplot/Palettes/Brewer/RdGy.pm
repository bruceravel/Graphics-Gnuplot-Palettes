package Graphics::Gnuplot::Palettes::Brewer::RdGy;
...
our @EXPORT_OK = qw($RdGy);
our $RdGy = 'set palette defined ( 0 "#B2182B", 1 "#D6604D", 2 "#F4A582", 3 "#FDDBC7", 4 "#E0E0E0", 5 "#BABABA", 6 "#878787", 7 "#4D4D4D" )';
