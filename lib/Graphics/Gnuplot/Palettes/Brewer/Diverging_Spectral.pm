package Graphics::Gnuplot::Palettes::Brewer::Diverging_Spectral;
...
our @EXPORT_OK = qw($Diverging_Spectral);
our $Diverging_Spectral = 'defined ( 0 "#D53E4F", 1 "#F46D43", 2 "#FDAE61", 3 "#FEE08B", 4 "#E6F598", 5 "#ABDDA4", 6 "#66C2A5", 7 "#3288BD" )';
