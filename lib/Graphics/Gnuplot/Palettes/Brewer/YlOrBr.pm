package Graphics::Gnuplot::Palettes::Brewer::YlOrBr;
...
our @EXPORT_OK = qw($YlOrBr);
our $YlOrBr = 'set palette defined ( 0 "#FFFFE5", 1 "#FFF7BC", 2 "#FEE391", 3 "#FEC44F", 4 "#FE9929", 5 "#EC7014", 6 "#CC4C02", 7 "#8C2D04" )';
