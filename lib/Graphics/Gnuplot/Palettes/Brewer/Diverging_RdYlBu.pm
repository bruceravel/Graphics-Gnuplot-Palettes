package Graphics::Gnuplot::Palettes::Brewer::Diverging_RdYlBu;
...
our @EXPORT_OK = qw($Diverging_RdYlBu);
our $Diverging_RdYlBu = 'defined ( 0 "#D73027", 1 "#F46D43", 2 "#FDAE61", 3 "#FEE090", 4 "#E0F3F8", 5 "#ABD9E9", 6 "#74ADD1", 7 "#4575B4" )';
