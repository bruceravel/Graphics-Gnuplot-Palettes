package Graphics::Gnuplot::Palettes::Brewer::Qualitative_Accent;
...
our @EXPORT_OK = qw($Qualitative_Accent);
our $Qualitative_Accent = 'defined ( 0 "#7FC97F", 1 "#BEAED4", 2 "#FDC086", 3 "#FFFF99", 4 "#386CB0", 5 "#F0027F", 6 "#BF5B17", 7 "#666666" )';
