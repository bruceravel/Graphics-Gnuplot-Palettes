package Graphics::Gnuplot::Palettes::Brewer::Sequential_YlOrRd;
...
our @EXPORT_OK = qw($Sequential_YlOrRd);
our $Sequential_YlOrRd = 'defined ( 0 "#FFFFCC", 1 "#FFEDA0", 2 "#FED976", 3 "#FEB24C", 4 "#FD8D3C", 5 "#FC4E2A", 6 "#E31A1C", 7 "#B10026" )';
