package Graphics::Gnuplot::Palettes::Brewer::Sequential_PuBu;
...
our @EXPORT_OK = qw($Sequential_PuBu);
our $Sequential_PuBu = 'defined ( 0 "#FFF7FB", 1 "#ECE7F2", 2 "#D0D1E6", 3 "#A6BDDB", 4 "#74A9CF", 5 "#3690C0", 6 "#0570B0", 7 "#034E7B" )';
