package Graphics::Gnuplot::Palettes::Brewer::BrBG;
...
our @EXPORT_OK = qw($BrBG);
our $BrBG = 'set palette defined ( 0 "#8C510A", 1 "#BF812D", 2 "#DFC27D", 3 "#F6E8C3", 4 "#C7EAE5", 5 "#80CDC1", 6 "#35978F", 7 "#01665E" )';
