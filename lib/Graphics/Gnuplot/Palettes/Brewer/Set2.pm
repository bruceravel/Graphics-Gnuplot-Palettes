package Graphics::Gnuplot::Palettes::Brewer::Set2;
...
our @EXPORT_OK = qw($Set2);
our $Set2 = 'set palette defined ( 0 "#66C2A5", 1 "#FC8D62", 2 "#8DA0CB", 3 "#E78AC3", 4 "#A6D854", 5 "#FFD92F", 6 "#E5C494", 7 "#B3B3B3" )';
