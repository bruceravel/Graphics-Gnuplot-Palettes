package Graphics::Gnuplot::Palettes::Brewer::GnBu;
...
our @EXPORT_OK = qw($GnBu);
our $GnBu = 'set palette defined ( 0 "#F7FCF0", 1 "#E0F3DB", 2 "#CCEBC5", 3 "#A8DDB5", 4 "#7BCCC4", 5 "#4EB3D3", 6 "#2B8CBE", 7 "#08589E" )';
