package Graphics::Gnuplot::Palettes::Brewer::Qualitative_Set3;
...
our @EXPORT_OK = qw($Qualitative_Set3);
our $Qualitative_Set3 = 'defined ( 0 "#8DD3C7", 1 "#FFFFB3", 2 "#BEBADA", 3 "#FB8072", 4 "#80B1D3", 5 "#FDB462", 6 "#B3DE69", 7 "#FCCDE5" )';
