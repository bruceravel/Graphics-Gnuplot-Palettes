package Graphics::Gnuplot::Palettes::Brewer::Sequential_YlGn;
...
our @EXPORT_OK = qw($Sequential_YlGn);
our $Sequential_YlGn = 'defined ( 0 "#FFFFE5", 1 "#F7FCB9", 2 "#D9F0A3", 3 "#ADDD8E", 4 "#78C679", 5 "#41AB5D", 6 "#238443", 7 "#005A32" )';
