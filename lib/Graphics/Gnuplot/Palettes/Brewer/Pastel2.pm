package Graphics::Gnuplot::Palettes::Brewer::Pastel2;
...
our @EXPORT_OK = qw($Pastel2);
our $Pastel2 = 'set palette defined ( 0 "#B3E2CD", 1 "#FDCDAC", 2 "#CDB5E8", 3 "#F4CAE4", 4 "#D6F5C9", 5 "#FFF2AE", 6 "#F1E2CC", 7 "#CCCCCC" )';
