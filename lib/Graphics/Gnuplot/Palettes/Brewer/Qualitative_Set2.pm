package Graphics::Gnuplot::Palettes::Brewer::Qualitative_Set2;
...
our @EXPORT_OK = qw($Qualitative_Set2);
our $Qualitative_Set2 = 'defined ( 0 "#66C2A5", 1 "#FC8D62", 2 "#8DA0CB", 3 "#E78AC3", 4 "#A6D854", 5 "#FFD92F", 6 "#E5C494", 7 "#B3B3B3" )';
