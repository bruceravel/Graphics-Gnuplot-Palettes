package Graphics::Gnuplot::Palettes::Brewer::PuOr;
...
our @EXPORT_OK = qw($PuOr);
our $PuOr = 'set palette defined ( 0 "#B35806", 1 "#E08214", 2 "#FDB863", 3 "#FEE0B6", 4 "#D8DAEB", 5 "#B2ABD2", 6 "#8073AC", 7 "#542788" )';
