package Graphics::Gnuplot::Palettes::Brewer::Sequential_Oranges;
...
our @EXPORT_OK = qw($Sequential_Oranges);
our $Sequential_Oranges = 'defined ( 0 "#FFF5EB", 1 "#FEE6CE", 2 "#FDD0A2", 3 "#FDAE6B", 4 "#FD8D3C", 5 "#F16913", 6 "#D94801", 7 "#8C2D04" )';
