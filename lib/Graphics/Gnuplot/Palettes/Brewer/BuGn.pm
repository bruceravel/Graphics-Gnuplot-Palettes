package Graphics::Gnuplot::Palettes::Brewer::BuGn;
...
our @EXPORT_OK = qw($BuGn);
our $BuGn = 'set palette defined ( 0 "#F7FCFD", 1 "#E5F5F9", 2 "#CCECE6", 3 "#99D8C9", 4 "#66C2A4", 5 "#41AE76", 6 "#238B45", 7 "#005824" )';
