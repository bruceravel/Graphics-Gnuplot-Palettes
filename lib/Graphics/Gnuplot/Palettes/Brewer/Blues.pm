package Graphics::Gnuplot::Palettes::Brewer::Blues;
...
our @EXPORT_OK = qw($Blues);
our $Blues = 'set palette defined ( 0 "#F7FBFF", 1 "#DEEBF7", 2 "#C6DBEF", 3 "#9ECAE1", 4 "#6BAED6", 5 "#4292C6", 6 "#2171B5", 7 "#084594" )';
