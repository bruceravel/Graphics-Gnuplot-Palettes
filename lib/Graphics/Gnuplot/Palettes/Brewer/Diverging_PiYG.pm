package Graphics::Gnuplot::Palettes::Brewer::Diverging_PiYG;
...
our @EXPORT_OK = qw($Diverging_PiYG);
our $Diverging_PiYG = 'defined ( 0 "#C51B7D", 1 "#DE77AE", 2 "#F1B6DA", 3 "#FDE0EF", 4 "#E6F5D0", 5 "#B8E186", 6 "#7FBC41", 7 "#4D9221" )';
