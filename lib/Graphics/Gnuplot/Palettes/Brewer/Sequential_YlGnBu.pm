package Graphics::Gnuplot::Palettes::Brewer::Sequential_YlGnBu;
...
our @EXPORT_OK = qw($Sequential_YlGnBu);
our $Sequential_YlGnBu = 'defined ( 0 "#FFFFD9", 1 "#EDF8B1", 2 "#C7E9B4", 3 "#7FCDBB", 4 "#41B6C4", 5 "#1D91C0", 6 "#225EA8", 7 "#0C2C84" )';
