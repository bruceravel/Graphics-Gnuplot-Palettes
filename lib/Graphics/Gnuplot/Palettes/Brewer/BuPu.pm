package Graphics::Gnuplot::Palettes::Brewer::BuPu;
...
our @EXPORT_OK = qw($BuPu);
our $BuPu = 'set palette defined ( 0 "#F7FCFD", 1 "#E0ECF4", 2 "#BFD3E6", 3 "#9EBCDA", 4 "#8C96C6", 5 "#8C6BB1", 6 "#88419D", 7 "#6E016B" )';
