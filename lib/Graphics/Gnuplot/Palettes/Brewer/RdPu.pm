package Graphics::Gnuplot::Palettes::Brewer::RdPu;
...
our @EXPORT_OK = qw($RdPu);
our $RdPu = 'set palette defined ( 0 "#FFF7F3", 1 "#FDE0DD", 2 "#FCC5C0", 3 "#FA9FB5", 4 "#F768A1", 5 "#DD3497", 6 "#AE017E", 7 "#7A0177" )';
