package Graphics::Gnuplot::Palettes::Brewer::Qualitative_Set1;
...
our @EXPORT_OK = qw($Qualitative_Set1);
our $Qualitative_Set1 = 'defined ( 0 "#E41A1C", 1 "#377EB8", 2 "#4DAF4A", 3 "#984EA3", 4 "#FF7F00", 5 "#FFFF33", 6 "#A65628", 7 "#F781BF" )';
