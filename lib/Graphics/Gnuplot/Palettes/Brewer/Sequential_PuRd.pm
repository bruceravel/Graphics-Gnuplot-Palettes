package Graphics::Gnuplot::Palettes::Brewer::Sequential_PuRd;
...
our @EXPORT_OK = qw($Sequential_PuRd);
our $Sequential_PuRd = 'defined ( 0 "#F7F4F9", 1 "#E7E1EF", 2 "#D4B9DA", 3 "#C994C7", 4 "#DF65B0", 5 "#E7298A", 6 "#CE1256", 7 "#91003F" )';
