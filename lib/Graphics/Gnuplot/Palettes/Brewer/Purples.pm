package Graphics::Gnuplot::Palettes::Brewer::Purples;
...
our @EXPORT_OK = qw($Purples);
our $Purples = 'set palette defined ( 0 "#FCFBFD", 1 "#EFEDF5", 2 "#DADAEB", 3 "#BCBDDC", 4 "#9E9AC8", 5 "#807DBA", 6 "#6A51A3", 7 "#4A1486" )';
